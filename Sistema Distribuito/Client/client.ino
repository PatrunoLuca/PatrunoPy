...
#define SENSOR_NUMBER "XXX" // It's important to put a different number on every device to handle the data on the server

// Delay between every iteration of the cycle
#define DELAY 500 // WIP
...
void loop()
{
    if ((WiFi.status() == WL_CONNECTED))
    {
        ...
        // Format data to json
        char post_data[] = "{\"humidity\" : " + String(h) + ", \"moisture\" : " + String(m) + ", \"temperature\" : " + String(t) + "}";
